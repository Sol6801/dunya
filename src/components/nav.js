          ...
          <div className="container mx-auto h-full flex flex-col justify-center items-center lg:flex-row lg:justify-end lg:h-auto lg:py-5 py-8">
            <ul className="list-reset flex flex-col lg:flex-row justify-center flex-1 items-center space-y-8 lg:space-y-0">
              <li className="mr-0 lg:mr-3">
                <button 
                onClick={home}
                className="nav-button inline-block py-2 px-4 text-2xl lg:text-base font-bold no-underline text-white hover:text-blue-700">
                  Inicio
                </button>
              </li>
              <li className="mr-0 lg:mr-3">
                <button 
                onClick={nos}
                className="nav-button inline-block py-2 px-4 text-2xl lg:text-base no-underline text-white hover:text-blue-700">
                  Nosotros
                </button>
              </li>
              <li className="mr-0 lg:mr-3">
                <button 
                onClick={exp}
                className="nav-button inline-block no-underline text-2xl lg:text-base text-white hover:text-blue-700 py-2 px-4">
                  Experiencia
                </button>
              </li>
            </ul>
